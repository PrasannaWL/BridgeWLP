 ...
 */	
 	if (voice_command) {
		...
		var commands = {
			...
			'show dashboard' : function() { $('nav a[href="/"] span').trigger("click"); },
			'show roles' : function() { $('nav a[href="/misc/roles"] span').trigger("click"); },
			'show settings': function () { window.location.href = '/account/settings'; },
